...
?>
                                <tbody>
                                    <tr>
                                        ...
                                        <?php  echo"<td><a class='approve'style='text-decoration: none;' href ='Accept.php?leaveId=$LeaveID'>Approve</a>"?>
          
                                        </td>
                                        <td>
                                        
                                        <?php  echo"<td><a class='Decline'style='text-decoration: none;' href ='Decline.php?leaveId=$LeaveID'>Decline</a>"?>               
                                </td>
